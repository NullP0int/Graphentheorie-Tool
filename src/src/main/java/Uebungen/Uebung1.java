...
public class Uebung1 {
    ...
    Example_Delivery_U1 exampleDelivery_U1;

    public Uebung1(Example_Delivery_U1 exampleDelivery_U1, Converter convert) {

        // This is for U1
        this.exampleDelivery_U1 = exampleDelivery_U1;
        CalculateDegrees calcDegree = new CalculateDegrees();
        CalculateDegrees.Degree degree;

        System.out.println("MatrixA (adjMatrixA)");
        System.out.println(convert.MatrixToString(exampleDelivery_U1.adjMatrixA));
        List<ArrayList> adjList = convert.MatrixToList(exampleDelivery_U1.adjMatrixA);
        System.out.println("ListA (adjListeA)");
        System.out.println(convert.ListToString(adjList));


        System.out.println("ListB (adjListeB)");
        List<ArrayList> adjListB = (convert.adjListToList(exampleDelivery_U1.adjListeB));
        ...
        degree = calcDegree.getDegreesFromAdjMatrix(exampleDelivery_U1.adjMatrixA);
        ...
        degree = calcDegree.getDegreesFromAdjList(exampleDelivery_U1.adjListeB);
